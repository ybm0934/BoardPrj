...
<form name="write" method="post" action="<c:url value='/board/edit2.do'/>">
	...
	<input type="text" name="ip" value="${ip}" readonly="readonly">
	<input type="text" name="port" value="${port}" readonly="readonly">
	<input type="text" name="browser" value="${browser}" readonly="readonly">
</form>
</body>
</html>
